...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                    <a href="#"><i class='fa fa-lock'></i> <span>ADMINISTRAR</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="javascript:void(0);"  onclick="cargar_formulario(2);">Roles</a></li>
                        <li><a href="javascript:void(0);"  onclick="cargar_formulario(3);" >Permisos</a></li>
                    </ul>
                </li>
        </ul><!-- /.sidebar-menu -->
    </section>

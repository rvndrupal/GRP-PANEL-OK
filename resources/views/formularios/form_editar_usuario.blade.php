...
<div class="col-md-12">
    <a href="#"  class="btn btn-sm btn-danger cerrarModal" style="margin: 0 0 6px 1224px;" onclick="cerrarModal();"> X </a>
      ...
      <div class="box-body">
          ...
          <div class="col-md-6">
              <div class="form-group">
                    ...
                    <div class="col-sm-10" >
                      <input type="text" class="form-control" id="nombres" name="nombres"  value="{{ $usuario->username }}"  required   >
                       </div>
              </div><!-- /.form-group -->
          </div><!-- /.col -->
